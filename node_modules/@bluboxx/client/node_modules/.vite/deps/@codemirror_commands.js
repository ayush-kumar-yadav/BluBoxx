import {
  ...
  matchBrackets,
  syntaxTree
} from "./chunk-EMVFWXCZ.js";
import {
  Direction,
  EditorView
} from "./chunk-FOWS2LG7.js";
import {
  NodeProp
} from "./chunk-KYY2HEQY.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
...
var canUndoSelection = hasSelection(
  0
  /* BranchName.Done */
);
var canRedoSelection = hasSelection(
  0
  /* BranchName.Done */
);
...
var selectCharForwardLogical = (target) => extendSel(target, true, (range) => byCharLogical(target.state, range, true));
var selectCharBackwardLogical = (target) => extendSel(target, false, (range) => byCharLogical(target.state, range, false));
